...
| `odt.ts`                      | Gabarits ODT : lecture d'archive, repères `{{…}}`, substitution, une page par destinataire. **Pur** — testable sans base ni LibreOffice.                                                                                           |
| `odt-render.ts`               | Conversion ODT → PDF par LibreOffice. Seule dépendance système de l'application, confinée à ce fichier.                                                                                                                            |
| `certificate-placeholders.ts` | Catalogue des repères d'attestation. **Pur et sans aucun import** : lu par l'API comme par l'écran des modèles.                                                                                                                    |
| `certificates.ts`             | Attestations de réussite : valeurs des repères, choix du gabarit, filtre d'admission.                                                                                                                                              |
